...
def center_crop(im, output_size):
    ...
    #return im[152-64:152+64, 122-64:122+64, :]
    return im
...
def convert(source_dir, target_dir, crop_size, out_size, exts=[''], num_shards=128, tfrecords_prefix=''):
    ...
    # get meta-data
    path_list = []
    #source_dir = '/localSSD/guoyu/MCele_2p/'
    source_dir = '/home/safe_data_dir_2/guoyu/png_lanzhou_crop/'
    path_list = []
    #fp = open('/home/xujinchang/share/project/GAN/tf_WGAN_GP/msc_train100k','r')
    fp = open('/home/xujinchang/share/project/GAN/tf_WGAN_GP/lanzhou_train','r')
...
if __name__ == "__main__":
    # CelebA
     convert('/home/safe_data_dir_2/guoyu/png_lanzhou_crop/', '/home/xujinchang/GAN_lanc/lan_tfrecords_8_64', crop_size=[128, 128], out_size=[128, 128], 
